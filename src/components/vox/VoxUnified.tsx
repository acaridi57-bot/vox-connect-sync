...
export const VoxLogo = () => (
  <svg width="36" height="36" viewBox="0 0 36 36" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <text x="50%" y="54%" dominantBaseline="middle" textAnchor="middle" fill="white" fontSize="14" fontWeight="700" fontFamily="Inter, sans-serif">VT</text>
  </svg>
);
...
const ROBOTIC = [
  ...
  "carmit","damayanti","daria","eddy","flo","fred","giullare","gordon","grandma","grandpa",
  "kanya","lekha","luciana","luisa","magnus","moira","montse","nora","organ","paolo","reed",
  "rishi","sandy","serena","superstar","tessa","thomas","whisper","wobble","xander","yelda",
  "yuna","zuzana","arthur","bubbles","cellos","daniel","ellen","fiona","junior","kyoko","lee",
  ...
  "ralph","martha","jacques","helena","martin",
];

// Female voice name fragments per language
...
// Male voice name fragments per language
...
export function SettingsModal() {
  ...
  // Auto-select best voice when target language OR gender changes
  useEffect(() => {
